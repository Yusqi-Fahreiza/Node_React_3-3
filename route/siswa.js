...
// GET: /pelanggaran --> end point untuk mengakses data siswa
app.get("/", (req,res) => {
...
// POST: /pelanggaran --> end point untuk pencarian data siswa
app.post("/", (req,res) => {
...
// POST: /pelanggaran/save --> end point untuk insert data siswa
...
// POST: /pelanggaran/update --> end point untuk update data siswa
...
// DELETE: /pegawai/:id_pegawai --> end point untuk hapus data siswa
